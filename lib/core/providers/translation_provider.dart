...
enum Tr {
  ...
  // Dashboard
  totalMembers, totalSavings, totalLoan, totalOutstanding, activeLoans, monthlyCollection,
  // Members
  ...
  // Loans
  addLoan, totalLoanAmount, outstandingAmount, installmentAmount, loanStatus, active, closed,
  // Installments
...
const Map<Tr, Map<String, String>> _translations = {
  ...
  Tr.loans:              {'en': 'Loans',               'bn': 'ঋণ'},
  Tr.installments:       {'en': 'Installments',        'bn': 'কিস্তি'},
  ...
  Tr.totalLoan:          {'en': 'Total Loan',          'bn': 'মোট ঋণ'},
  Tr.totalOutstanding:   {'en': 'Total Outstanding',   'bn': 'মোট বকেয়া'},
  Tr.activeLoans:        {'en': 'Active Loans',        'bn': 'সক্রিয় ঋণ'},
  ...
  Tr.addLoan:            {'en': 'Add Loan',            'bn': 'ঋণ যোগ করুন'},
  Tr.totalLoanAmount:    {'en': 'Total Loan Amount',   'bn': 'মোট ঋণের পরিমাণ'},
  Tr.outstandingAmount:  {'en': 'Outstanding Amount',  'bn': 'বকেয়া পরিমাণ'},
  Tr.installmentAmount:  {'en': 'Installment Amount',  'bn': 'কিস্তির পরিমাণ'},
  Tr.loanStatus:         {'en': 'Loan Status',         'bn': 'ঋণের অবস্থা'},
  Tr.active:             {'en': 'Active',              'bn': 'সক্রিয়'},
  Tr.closed:             {'en': 'Closed',              'bn': 'বন্ধ'},
  Tr.addInstallment:     {'en': 'Add Installment',     'bn': 'কিস্তি যোগ করুন'},
  ...
  Tr.installmentHistory: {'en': 'Installment History', 'bn': 'কিস্তির ইতিহাস'},
  ...
  Tr.issuingLoanFor:     {'en': 'Issuing loan for',    'bn': 'ঋণ প্রদান করা হচ্ছে:'},
  ...
  Tr.loanIssuedSuccess:  {'en': 'Successfully issued loan', 'bn': 'সফলভাবে ঋণ প্রদান করা হয়েছে'},
