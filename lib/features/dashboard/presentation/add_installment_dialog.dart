...
class AddInstallmentDialog extends ConsumerStatefulWidget {
  const AddInstallmentDialog({super.key});

  @override
  ConsumerState<AddInstallmentDialog> createState() => _AddInstallmentDialogState();
}
...
class _AddInstallmentDialogState extends ConsumerState<AddInstallmentDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await ref.read(actionProvider).submitInstallment(
        amount: amount,
